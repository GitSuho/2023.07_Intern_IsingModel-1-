...
int main( int argc, char** argv ){
    ...
    uniform_real_distribution<float> distribution2(0, N-1);
    ...
    string fractal_filename = "ISING_FRACTAL_" +  to_string(sqrtN) + "x" + to_string(sqrtN) + "_effmc" + to_string(eff_mc_step) 
    +"_intv" +to_string(T_interval).substr(0, 5) + addition_name + ".txt";
    ofstream writefile_fractal(fractal_filename);
